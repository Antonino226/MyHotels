                  ...
                  <table id="dataTableExample" class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="{{ route('edit.amenitie',$item->id) }}" class="btn btn-outline-warning">Edit</a>
                        <a href="{{ route('delete.amenitie',$item->id) }}" class="btn btn-outline-danger" id="delete" >Delete</a></td>
                      </tr>
                      @endforeach
                    </tbody>
                  </table>
