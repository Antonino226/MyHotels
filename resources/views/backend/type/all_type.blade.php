                  ...
                  <table id="dataTableExample" class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="{{ route('edit.type',$item->id) }}" class="btn btn-outline-warning">Edit</a>
                        <a href="{{ route('delete.type',$item->id) }}" class="btn btn-outline-danger" id="delete" >Delete</a></td>
                      </tr>
                      @endforeach
                    </tbody>
                  </table>
